        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-5 text-lg text-gray-200">
              ...
              randomization—for just ₹99.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Button
                onClick={scrollToForm}
                size="lg"
                className="bg-gradient-to-r from-vlsi-500 to-vlsi-600 hover:from-vlsi-600 hover:to-vlsi-700 text-white font-semibold px-8 py-6 rounded-xl"
              >
              ...
              <div className="flex items-center gap-3 text-sm text-gray-300">
                ...
                <span>
                  Trusted by 500+ learners • Certificate of Completion
                </span>
              </div>
            </div>
