...
export const generateBrochurePDF = (userInfo?: {
  ...
  addText(
    "Duration: 8 Months | Base Fee: ₹XXXX | Level: Beginner to Advanced",
    pageWidth / 2,
    yPos + 18,
    {
      size: 11,
  ...
  // Description
  const description =
    "Transform your career with our comprehensive VLSI Design Verification program. Master the complete digital verification flow from RTL design to advanced verification methodologies.";

  yPos +=
    addText(description, leftMargin, yPos, {
      size: 11,
  ...
  coreModules.forEach((module) => {
    ...
    yPos +=
      addText(module, leftMargin + 8, yPos, {
        size: 10,
  ...
  addText(
    "Intel, Qualcomm, NVIDIA, Broadcom, AMD, MediaTek, Marvell, Synopsys, Cadence, Mentor Graphics",
    leftMargin,
    yPos,
    {
      size: 9,
  ...
  addText(
    "📞 +91 9052653636 | ✉️ admissions@azorix.com | 🌐 www.azorix.com",
    pageWidth / 2,
    yPos + 16,
    {
      size: 9,
  ...
  addText(
    "📍 3rd Floor, Tech Park Building, HITEC City, Madhapur, Hyderabad",
    pageWidth / 2,
    yPos + 22,
    {
      size: 8,
