                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                      <li>
                        All assignments and projects must be your own original
                        work
                      </li>
                      <li>
                        Collaboration is encouraged where explicitly permitted
                      </li>
                      <li>
                        Proper citation required for any external resources used
                      </li>
                      <li>
                        Plagiarism in any form will result in course dismissal
                      </li>
                    </ul>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
                      ...
                      <li>
                        Report any suspicious activity to instructors
                        immediately
                      </li>
                      <li>
                        Follow all technical guidelines for online assessments
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                      <li>
                        Minimum 80% attendance required for course completion
                      </li>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
                      ...
                      <li>
                        Respect others' learning by minimizing disruptions
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                      ...
                      <li>
                        No discriminatory language or behavior of any kind
                      </li>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
                      <li>
                        Electronic devices for educational purposes only during
                        class
                      </li>
                      <li>Silence mobile phones and notifications</li>
                      <li>
                        No recording without explicit instructor permission
                      </li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                      ...
                      <li>
                        Email responses within 24-48 hours for course-related
                        queries
                      </li>
                      <li>
                        Follow proper channels for complaints and grievances
                      </li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                      ...
                      <li>
                        No unauthorized sharing or distribution of materials
                      </li>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
                      ...
                      <li>
                        Institute may use student work for promotional purposes
                        with consent
                      </li>
                      <li>
                        Collaborative projects require clear ownership
                        agreements
                      </li>
                      <li>
                        Industry project work may have specific IP clauses
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                      ...
                      <li>
                        Re-evaluation requests require written justification
                      </li>
                    </ul>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                      <li>
                        <strong>First Offense:</strong> Verbal warning and
                        counseling
                      </li>
                      <li>
                        <strong>Second Offense:</strong> Written warning and
                        probation
                      </li>
                      <li>
                        <strong>Third Offense:</strong> Suspension from course
                      </li>
                      <li>
                        <strong>Severe Violations:</strong> Immediate dismissal
                      </li>
                    </ul>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <p className="text-gray-700 mb-2">
                        ...
                        <br />
                        Email: studentaffairs@azorix.com
                        <br />
                        Phone: +91 9052653636
                        <br />
                      ...
                      <p className="text-gray-600 text-sm mt-4">
                        ...
                        contact the Student Affairs Office during business hours
                        (9 AM - 6 PM).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <p className="text-blue-700 text-sm">
                      By enrolling in any course at Azorix VLSI, students
                      acknowledge they have read, understood, and agree to abide
                      by this Code of Conduct and Student Policy. Violations may
