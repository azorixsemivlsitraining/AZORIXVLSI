    ...
    try {
      ...
      try {
        ...
        if (r.ok) {
          ...
          const preview =
            (resources.resources || []).find((x: any) => x.title?.toLowerCase().includes("3-hour")) ||
            resources.resources?.[0];
          setVideoUrl(preview?.url || process.env.REACT_APP_COHORT_PREVIEW_VIDEO_URL || "https://youtu.be/YE-JrestfRw");
        } else {
  ...
  if (!accessGranted)
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center">
        <Header />
        <p className="text-lg text-gray-700">Payment required to access cohort preview.</p>
    ...
    <div className="min-h-screen">
      ...
      <main className="container max-w-3xl py-10">
        ...
        <p className="text-muted-foreground mb-6">
          Convert warm buyers into serious learners. Includes live sessions, assignments, TA support, and community.
        </p>
          ...
          <div className="mt-6">
            <div className="aspect-video bg-black rounded-lg overflow-hidden">
              <iframe
                ...
                src={videoUrl.includes("youtu") ? videoUrl.replace("watch?v=", "embed/") + "?enablejsapi=1" : videoUrl}
