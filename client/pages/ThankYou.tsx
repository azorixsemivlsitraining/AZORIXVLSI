...
export default function ThankYou() {
  const whatsapp =
    "https://wa.me/919052653636?text=Hi%2C%20I%20have%20joined%20the%20Azorix%20VLSI%20workshop%20community";
      ...
      <main className="flex-grow flex items-center justify-center py-20 px-4">
        <div className="max-w-xl w-full bg-white rounded-2xl shadow-lg p-10 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your ₹99 workshop registration is successful. Check your email for
